        ...
        <aside id="sidebar">
            ...
            <ul class="side-menu">
                ...
                <li class="sm-sub">
                    ...
                    <ul>
                        <li><a href="<?php echo e(url('admin/barang-jasa')); ?>">Barang & Jasa</a></li>
                        <li><a href="<?php echo e(url('admin/barang-jasa/kategori')); ?>">Kategori</a></li>
                    </ul>
                </li>
                <li class="sm-sub">
                    <a href="">
                    ...
                    <ul>
                        <li><a href="<?php echo e(url('admin/transaksi')); ?>">Transaksi</a></li>
                    </ul>
                </li>
            </ul>
        </aside>
...
<?php echo $__env->make('admin.layouts.plane', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
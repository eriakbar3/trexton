        ...
        <div class="container">
          <nav id="menuzord-right" class="menuzord orange bg-white">
            <a class="menuzord-brand pull-left flip xs-pull-center" href="<?php echo e(url('/')); ?>">
              <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="" style="width:40%; max-height:75px;">
            </a>
            <ul class="menuzord-menu">
              <li <?php if($s == 1): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('/')); ?>">Home</a></li>
              <li <?php if($s == 2): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('about-us')); ?>">About Us</a></li>
              <li <?php if($s == 3): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('kontak')); ?>">Kontak</a></li>
            </ul>
          </nav>
        </div>
      </div>
